...
namespace StringCalculator.Tests
{
    public class CalculatorTests
    {
        ...
        [InlineData("//;\n1;2;1000", 1003)]
        public void Add_ShouldIgnoreNumbersBiggerThan1000_WhenStringIsValid(string calculation, int expected)
        {
            // Arrange
            var sut = new Calculator();
        ...
        [InlineData("//[*][%]\n1*2%3", 6)]
        [InlineData("//[*][%]\n1*2%3,3", 9)]
        public void Add_AddsNumbersUsingMultipleCustomDelimiter_WhenStringIsValid(string calculation, int expected)
        {
            // Arrange
            var sut = new Calculator();
